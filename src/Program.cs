	...
	static class Program
	{
		...
		private static void UIThreadException(object sender, ThreadExceptionEventArgs t)
		{
			...
			try
			{
				...
				errorMsg += "Oops, sinzuku crashed! Please include the following information if you plan to contact the developers (a copy of the following information is stored in crash.txt in the application folder):\r\n\r\n";
				errorMsg += ex.Message + "\r\n\r\n";
		...
		private static void UnhandledException(object sender, UnhandledExceptionEventArgs e)
		{
			try
			{
				...
				errorMsg += "Oops, sinzuku crashed! Please include the following information if you plan to contact the developers:\r\n\r\n";
				errorMsg += ex.Message + "\r\n\r\n";
				errorMsg += "Stack Trace:\r\n" + ex.StackTrace + "\r\n\r\n";
				WriteErrorLog(errorMsg);

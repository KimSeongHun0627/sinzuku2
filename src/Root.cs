...
namespace sinzuku
{
	...
	public class Root
	{
		...
		public void SetDefaultConfig()
		{
			...
			AutoScroll = false;
			WhiteTrayIcon = false;
			SnapshotBasePath = "%USERPROFILE%/Pictures/sinzuku/";
		}
		...
		public void SetTrayIconColor()
		{
			if (WhiteTrayIcon)
			{
				if (File.Exists("icon_white.ico"))
					...
					trayIcon.Icon = global::sinzuku.Properties.Resources.icon_white;
			}
			else
			{
				if (File.Exists("icon_red.ico"))
					...
					trayIcon.Icon = global::sinzuku.Properties.Resources.icon_red;
			}
